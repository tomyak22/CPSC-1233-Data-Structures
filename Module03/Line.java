...
public class Line implements Comparable<Line>, Iterable<Point> {
    ...
    * Collection c.
    *
    * @param c collection of collinear points used to make a line
    */
    ...
    *
    * @param p point to be compared to other points to see if collinear
    */
