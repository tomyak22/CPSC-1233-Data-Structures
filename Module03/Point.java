...
public final class Point implements Comparable<Point> {
  ...
  */
    ...
    * negative infinity.
    *
    * @param that coordinates to be compared to to compute slope
   ...
   private class ComparePointsBySlope implements Comparator<Point> {
       ...
       *
       * @param p1 first point to determine order
       * @param p2 second point to determine order
       */
      @Override   
